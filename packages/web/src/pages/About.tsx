                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {values.map((value) => (
                            <Card key={value.title} className="p-8 text-center border-2 border-transparent hover:border-red-500 transition-colors">
                                <div className="w-16 h-16 mx-auto mb-6 rounded-lg bg-red-600 flex items-center justify-center">
                        ...
                        {team.map((member) => (
                            <div key={member.name} className="text-center">
                                <img
                                    src={member.image}
                                    alt={member.name}
                                    className="w-32 h-32 mx-auto rounded-full object-cover mb-4 border-4 border-red-100 dark:border-red-900/30"
                                />
