...
export default function TeacherProfile() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Đang tải thông tin giảng viên...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            {/* Hero Section */}
            <section className="relative py-16 bg-gradient-to-br from-red-600 via-red-700 to-red-900 overflow-hidden">
            ...
            <section className="py-8 -mt-8 relative z-20">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                        <Card className="p-6 text-center bg-white dark:bg-gray-900 shadow-xl">
                        ...
                        <Card className="p-6 text-center bg-white dark:bg-gray-900 shadow-xl col-span-2 md:col-span-1">
                            <GraduationCap className="w-8 h-8 mx-auto mb-2 text-green-600" />
                            <div className="text-3xl font-bold text-gray-900 dark:text-white">
                                {teacher.courses.reduce((sum, c) => sum + c.totalModules, 0)}
                            </div>
                            <div className="text-sm text-gray-600 dark:text-gray-400">Bài giảng</div>
                        </Card>
                    </div>
                </div>
            </section>
                            ...
                            {teacher.courses.map((course) => (
                                <Link key={course.id} to={`/courses/${course.id}`}>
                                    <Card className="overflow-hidden hover:shadow-xl transition-all group h-full">
                                        {/* Thumbnail */}
                                        <div className="aspect-video bg-gradient-to-br from-red-500 to-red-700 relative overflow-hidden">
                                            {course.thumbnailUrl ? (
                                                <img
                                        ...
                                        {/* Content */}
                                        <div className="p-5">
                                            <h3 className="font-bold text-gray-900 dark:text-white mb-2 line-clamp-2 group-hover:text-red-600 transition-colors">
                                                {course.title}
                                            </h3>
